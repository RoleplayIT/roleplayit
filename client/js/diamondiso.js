    ...
    diamondIso:{
        ...
        */
        place:function(obj,x,y,layer){
            ...
            obj.x = pos.left+(marginX)-obj.w/2;
        ...
        px2pos:function(left,top){
            ...
            return {
                x:Math.ceil((top+x) / this._tile.height),
                y:Math.ceil((top-x) / this._tile.height)
            }
        },
        ...
        polygonGrid:function(offset){
            var poly = new Crafty.polygon( [[this._tile.width/2,offset],[this._tile.width,this._tile.height/2+offset],[this._tile.width/2,this._tile.height+offset],[0,this._tile.height/2+offset]] );
            return poly
        }
