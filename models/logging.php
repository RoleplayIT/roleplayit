...
class Logging {
	...
	public static function lwrite($message) {
		...
		fwrite(Logging::$fp, "$time ($script_name) $message" . PHP_EOL);
	}
	...
	private static function lopen() {
		...
		$lfile = Logging::$log_file ? Logging::$log_file : $log_file_default;
		// open log file for writing only and place file pointer at the end of the file
		// (if the file does not exist, try to create it)
		Logging::$fp = fopen($lfile, 'a') or exit("Can't open $lfile!");
	}
}
